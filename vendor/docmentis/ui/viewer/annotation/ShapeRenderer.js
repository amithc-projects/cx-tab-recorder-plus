 ...
 */
export function renderLine(layer, annotation, scale) {
 ...
 */
export function renderSquare(layer, annotation, scale) {
    const svg = createSvgOverlay();
    const color = colorToRgb(annotation.color, "rgb(0, 0, 0)");
 ...
 */
export function renderCircle(layer, annotation, scale) {
    const svg = createSvgOverlay();
    const color = colorToRgb(annotation.color, "rgb(0, 0, 0)");
    const interiorColor = annotation.interiorColor ? colorToRgb(annotation.interiorColor, "none") : "none";
    const strokeWidth = (annotation.borderWidth ?? 1) * scale;
 ...
 */
export function renderPolygon(layer, annotation, scale) {
 ...
 */
export function renderPolyLine(layer, annotation, scale) {
    if (!annotation.vertices || annotation.vertices.length < 2) {
        return document.createElement("div");
    }
    const svg = createSvgOverlay();
 ...
 */
export function renderInk(layer, annotation, scale) {
 ...
 */
export function renderRedact(layer, annotation, scale) {
    const svg = createSvgOverlay();
