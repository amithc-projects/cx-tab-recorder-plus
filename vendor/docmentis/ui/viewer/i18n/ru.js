export const ru = {
    ...
    "shell.shortcutHelp": "Сочетания клавиш: F6 — переход между областями, Ctrl+F — поиск, Ctrl+P — печать, " +
    ...
    "shell.shortcutHelpAnnounce": "Сочетания клавиш: F6 переход между областями, Ctrl+F поиск, Ctrl+P печать, " +
