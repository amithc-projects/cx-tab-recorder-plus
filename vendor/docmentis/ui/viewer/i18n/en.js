export const en = {
    ...
    "shell.shortcutHelp": "Keyboard shortcuts: F6 to navigate regions, Ctrl+F to search, Ctrl+P to print, " +
        "Ctrl+Plus to zoom in, Ctrl+Minus to zoom out, Ctrl+0 to reset zoom, Escape to close panels. " +
        "Press ? for a list of shortcuts.",
    "shell.shortcutHelpAnnounce": "Keyboard shortcuts: F6 navigate regions, Ctrl+F search, Ctrl+P print, " +
