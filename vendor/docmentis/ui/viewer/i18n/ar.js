export const ar = {
    ...
    "shell.shortcutHelp": "اختصارات لوحة المفاتيح: F6 للتنقل بين الأقسام، Ctrl+F للبحث، Ctrl+P للطباعة، " +
        "Ctrl+Plus للتكبير، Ctrl+Minus للتصغير، Ctrl+0 لإعادة ضبط التكبير، Escape لإغلاق اللوحات. " +
        "اضغط ? لعرض قائمة الاختصارات.",
    "shell.shortcutHelpAnnounce": "اختصارات لوحة المفاتيح: F6 التنقل بين الأقسام، Ctrl+F البحث، Ctrl+P الطباعة، " +
