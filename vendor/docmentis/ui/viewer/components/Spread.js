import { makeRenderKey } from "../../../worker/index.js";
 ...
 */
export function createSpread(data, showAttribution = true, i18n, customPageOverlay) {
                ...
                if (cropMode === "vertical") {
                    ...
                    switch (effectiveRotation) {
                        ...
                        case 90:
                            ...
                            break;
                        case 180:
                            cropOffsetLeft = -(slotEl.cssWidth -
                                toCssPixels(crLeftDevice, dpr) -
                                toCssPixels(crWidthDevice, dpr));
                            cropOffsetTop = -(slotEl.cssHeight -
                                toCssPixels(crTopDevice, dpr) -
                            ...
                            break;
                        case 270:
                            cropOffsetLeft = -(slotEl.cssHeight -
                                toCssPixels(crTopDevice, dpr) -
                                toCssPixels(crHeightDevice, dpr));
    ...
    function updateSearchHighlights(matches, activeIndex, options) {
        ...
        for (const slotEl of slotElements) {
            ...
            if (matches === slotEl.lastSearchMatches &&
