...
import { ICON_MENU, ICON_MORE, ICON_SEARCH, ICON_COMMENTS, ICON_FULLSCREEN, ICON_FULLSCREEN_EXIT, ICON_CHEVRON_LEFT, ICON_CHEVRON_RIGHT, ICON_CHEVRON_DOWN, ICON_ZOOM_IN, ICON_ZOOM_OUT, ICON_THEME_LIGHT, ICON_THEME_DARK, ICON_THEME_SYSTEM, ICON_DOWNLOAD, ICON_PRINT, ICON_TOOL_POINTER, ICON_TOOL_HAND, ICON_TOOL_ZOOM, ICON_TOOL_ANNOTATE, ICON_TOOL_MARKUP, } from "../icons";
...
const LEFT_TABS = ["thumbnail", "outline", "bookmarks", "layers", "attachments"];
function sliceEqual(a, b) {
    return (a.toolbarVisible === b.toolbarVisible &&
...
export function createToolbar() {
    ...
    function mount(container, store, i18n) {
        ...
        function buildZoomDropdown(slice, store) {
        ...
        const applyState = (slice) => {
            ...
            const themeIcon = slice.theme === "light"
                ? ICON_THEME_DARK
                : slice.theme === "dark"
                    ? ICON_THEME_SYSTEM
                    : ICON_THEME_LIGHT;
            const themeLabel = slice.theme === "light"
            ...
            const anySimpleEnabled = !slice.disabledTools.has("pointer") ||
