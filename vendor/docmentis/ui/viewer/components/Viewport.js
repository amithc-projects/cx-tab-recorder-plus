...
export function createViewport(showAttribution = true, customPageOverlay) {
    ...
    function captureSnapshot(spreadComp) {
        ...
        const mainCanvas = el.querySelector(".udoc-spread__canvas") ??
    ...
    function showSingleSpread(slice, _metrics, state) {
        ...
        const wantTransition = isNewSpread &&
            pageTransition != null &&
